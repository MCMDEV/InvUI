...
public class InventoryAccess {
    ...
    private static final Constructor<AnvilInventory> ANVIL_INVENTORY_CONSTRUCTOR =
        ReflectionUtils.getConstructor(ANVIL_INVENTORY_CLASS, false, Player.class, ComponentHolder.class, Consumer.class);
    private static final Constructor<CartographyInventory> CARTOGRAPHY_INVENTORY_CONSTRUCTOR =
        ReflectionUtils.getConstructor(CARTOGRAPHY_INVENTORY_CLASS, false, Player.class, ComponentHolder.class);
     ...
     * @param title         The inventory title as a {@link ComponentHolder}
     ...
     */
    public static AnvilInventory createAnvilInventory(@NotNull Player player, @NotNull ComponentHolder title, Consumer<String> renameHandler) {
     ...
     */
    public static CartographyInventory createCartographyInventory(@NotNull Player player, @NotNull ComponentHolder title) {
