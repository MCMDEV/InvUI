...
public abstract class SplitWindow extends MergedWindow {
    ...
    public SplitWindow(Player player, ComponentHolder title, GUI upperGui, GUI lowerGui, Inventory upperInventory, boolean initItems, boolean closeable, boolean closeOnEvent) {
