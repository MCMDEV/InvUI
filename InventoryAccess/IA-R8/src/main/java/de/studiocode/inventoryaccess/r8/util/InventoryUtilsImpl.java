...
public class InventoryUtilsImpl implements InventoryUtils {
    ...
    public static Component createNMSComponent(ComponentHolder componentHolder) {
        return CraftChatMessage.fromJSON(componentHolder.toJson());
    }
    ...
    @Override
    public void openCustomInventory(@NotNull Player player, @NotNull Inventory inventory, @Nullable ComponentHolder title) {
    ...
    @Override
    public void updateOpenInventoryTitle(@NotNull Player player, @NotNull ComponentHolder title) {
        ServerPlayer serverPlayer = ((CraftPlayer) player).getHandle();
